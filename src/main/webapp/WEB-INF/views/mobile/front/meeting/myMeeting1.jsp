						...
						success : function(data) {
							if (data.code == 1) {
								...
								for (var i = 0; i < data.list.length; i++) {
									...
									var html = "<h4 style=\"color: #4AACC5\" align=\"center\">"+data.list[i].subject.substring(0,data.list[i].subject.length>30?30:data.list[i].subject.length)+"</h3>"+

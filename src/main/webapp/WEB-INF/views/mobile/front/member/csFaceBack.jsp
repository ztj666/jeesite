...
<body>
	...
	<form id="subForm" action="${ctxw }/csCenter/faceBackSave.htm" method="post">
		<h1 class="message_h">标题</h1>
		<div class="mui-input-group" style="position: absolute; top: 110px; left: 20px; right: 20px; height: 50px;">
			<div class="div_box_input">
				<input name="subject" type="text" maxlength="30" style="height: 22px; border: 0px; font-size: 16px; color: #BBBBBB; line-height: 22px;">
			</div>
		</div>
		<h1 class="message_h" style="top: 172px;">内容</h1>

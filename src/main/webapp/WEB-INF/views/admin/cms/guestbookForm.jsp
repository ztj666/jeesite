...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/cms/guestbook/form.do?id=${guestbook.id}">留言<shiro:hasPermission name="cms:guestbook:edit">${guestbook.delFlag eq '2'?'审核':'查看'}</shiro:hasPermission><shiro:lacksPermission name="cms:guestbook:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="guestbook" action="${ctx}/cms/guestbook/save.do" method="post" class="form-horizontal">
		<form:hidden path="id"/>

...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cms/link.do?category.id=${link.category.id}">链接列表</a></li>
	...
	<form:form id="inputForm" modelAttribute="link" action="${ctx}/cms/link/save.do" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="category" name="category.id" value="${link.category.id}" labelName="category.name" labelValue="${link.category.name}"
					title="栏目" url="/cms/category/treeData.do" module="link" selectScopeModule="true" notAllowSelectRoot="false" notAllowSelectParent="true" cssClass="required"/>
			</div>
		</div>
		<div class="control-group">

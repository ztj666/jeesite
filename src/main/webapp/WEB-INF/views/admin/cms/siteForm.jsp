...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cms/site.do">站点列表</a></li>
		<li class="active"><a href="${ctx}/cms/site/form.do?id=${site.id}">站点<shiro:hasPermission name="cms:site:edit">${not empty site.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cms:site:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="site" action="${ctx}/cms/site/save.do" method="post" class="form-horizontal">
		<form:hidden path="id"/>

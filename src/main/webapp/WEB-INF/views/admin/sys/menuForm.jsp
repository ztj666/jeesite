...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/menu.do">菜单列表</a></li>
		<li class="active"><a href="${ctx}/sys/menu/form.do?id=${menu.id}&parent.id=${menu.parent.id}">菜单<shiro:hasPermission name="sys:menu:edit">${not empty menu.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:menu:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>

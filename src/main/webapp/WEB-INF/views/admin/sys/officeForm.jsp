...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/office/list.do?id=${office.parent.id}&parentIds=${office.parentIds}">机构列表</a></li>
		...
		<div class="control-group">
			...
			<div class="controls">
				 <sys:treeselect id="primaryPerson" name="primaryPerson.id" value="${office.primaryPerson.id}" labelName="office.primaryPerson.name" labelValue="${office.primaryPerson.name}"
					title="用户" url="/sys/office/treeData.do?type=3" allowClear="true" notAllowSelectParent="true"/>
			</div>
		</div>
		<div class="control-group">

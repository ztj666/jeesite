	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			function getNotifyNum(){
				$.get("${ctx}/oa/oaNotify/self/count.do?updateSession=0&t="+new Date().getTime(),function(data){
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					<li><a href="${ct}/" target="_blank" title="访问网站主页"><i class="icon-home"></i></a></li>
					...
					<li id="userInfo" class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="${ctx}/sys/user/info.do" target="mainFrame"><i class="icon-user"></i>&nbsp; 个人信息</a></li>
							<li><a href="${ctx}/sys/user/modifyPwd.do" target="mainFrame"><i class="icon-lock"></i>&nbsp;  修改密码</a></li>
							<li><a href="${ctx}/oa/oaNotify/self.do" target="mainFrame"><i class="icon-bell"></i>&nbsp;  我的通知 <span id="notifyNum2" class="label label-info hide"></span></a></li>
						</ul>
					</li>
				...
				<div class="nav-collapse">
					<ul id="menu" class="nav" style="*white-space:nowrap;float:none;">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<c:forEach items="${fnc:getSiteList()}" var="site"><li><a href="${ctx}/cms/site/select.do?id=${site.id}&flag=1">${site.name}</a></li></c:forEach>
							</ul>
						</li>
						</shiro:hasPermission> --%>
					</ul>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} <!-- - Powered By <a href="http://www.sc.com" target="_blank">FDP</a> ${fns:getConfig('version')}-->
			</div>
		</div>
	</div>
	<script type="text/javascript"> 

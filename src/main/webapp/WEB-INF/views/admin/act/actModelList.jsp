...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
        	location = '${ctx}/act/model.do?pageNo='+n+'&pageSize='+s;
        }
	...
	<script type="text/template" id="categoryBox">
		<form id="categoryForm" action="${ctx}/act/model/updateCategory.do" method="post" enctype="multipart/form-data"
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/act/model.do">模型管理</a></li>
		<li><a href="${ctx}/act/model/create.do">新建模型</a></li>
	</ul>
	<form id="searchForm" action="${ctx}/act/model.do" method="post" class="breadcrumb form-search">
			...
			<c:forEach items="${page.list}" var="model">
				<tr>
					...
					<td>
						...
						<a href="${ctx}/act/model/deploy.do?id=${model.id}" onclick="return confirmx('确认要部署该模型吗？', this.href)">部署</a>
						<a href="${ctx}/act/model/export.do?id=${model.id}" target="_blank">导出</a>
	                    <a href="${ctx}/act/model/delete.do?id=${model.id}" onclick="return confirmx('确认要删除该模型吗？', this.href)">删除</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>

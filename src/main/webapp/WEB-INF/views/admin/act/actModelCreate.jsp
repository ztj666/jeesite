		...
		$(document).ready(function(){
			...
			$("#inputForm").validate({
				submitHandler: function(form){
					loading('正在提交，请稍等...');
					form.submit();
					setTimeout(function(){location='${ctx}/act/model.do'}, 1000);
				},
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/act/model.do">模型管理</a></li>
		<li class="active"><a href="${ctx}/act/model/create.do">新建模型</a></li>
	</ul><br/>
	<sys:message content="${message}"/>
	<form id="inputForm" action="${ctx}/act/model/create.do" target="_blank" method="post" class="form-horizontal">

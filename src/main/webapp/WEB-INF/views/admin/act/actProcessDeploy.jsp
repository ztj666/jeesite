...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/act/process/deploy.do">部署流程</a></li>
		<li><a href="${ctx}/act/process/running.do">运行中的流程</a></li>
	</ul><br/>
	<sys:message content="${message}"/>
	<form id="inputForm" action="${ctx}/act/process/deploy.do" method="post" enctype="multipart/form-data" class="form-horizontal">

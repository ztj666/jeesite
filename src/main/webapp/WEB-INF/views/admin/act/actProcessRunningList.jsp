...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
        	location = '${ctx}/act/process/running.do?pageNo='+n+'&pageSize='+s;
        }
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/act/process.do">流程管理</a></li>
		<li><a href="${ctx}/act/process/deploy.do">部署流程</a></li>
		<li class="active"><a href="${ctx}/act/process/running.do">运行中的流程</a></li>
	</ul>
	<form id="searchForm" action="${ctx}/act/process/running.do" method="post" class="breadcrumb form-search">
				...
				<tr>
					...
					<td>
						<shiro:hasPermission name="act:process:edit">
							<a href="${ctx}/act/process/deleteProcIns.do?procInsId=${procIns.processInstanceId}&reason=" onclick="return promptx('删除流程','删除原因',this.href);">删除流程</a>
						</shiro:hasPermission>&nbsp;
					</td>
				</tr>
			</c:forEach>

...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/gen/genTemplate.do">代码模板列表</a></li>
		<li class="active"><a href="${ctx}/gen/genTemplate/form.do?id=${genTemplate.id}">代码模板<shiro:hasPermission name="gen:genTemplate:edit">${not empty genTemplate.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="gen:genTemplate:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="genTemplate" action="${ctx}/gen/genTemplate/save.do" method="post" class="form-horizontal">
		<form:hidden path="id"/>

...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/gen/genScheme.do">生成方案列表</a></li>
		<li class="active"><a href="${ctx}/gen/genScheme/form.do?id=${genScheme.id}">生成方案<shiro:hasPermission name="gen:genScheme:edit">${not empty genScheme.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="gen:genScheme:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="genScheme" action="${ctx}/gen/genScheme/save.do" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">建议模块包：com.qhwl.admin</span>
			</div>
		</div>
		<div class="control-group">

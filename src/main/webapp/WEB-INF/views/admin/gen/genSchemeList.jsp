...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/gen/genScheme.do">生成方案列表</a></li>
		<shiro:hasPermission name="gen:genScheme:edit"><li><a href="${ctx}/gen/genScheme/form.do">生成方案添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="genScheme" action="${ctx}/gen/genScheme.do" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="genScheme">
			<tr>
				<td><a href="${ctx}/gen/genScheme/form.do?id=${genScheme.id}">${genScheme.name}</a></td>
				...
				<shiro:hasPermission name="gen:genScheme:edit"><td>
    				<a href="${ctx}/gen/genScheme/form.do?id=${genScheme.id}">修改</a>
					<a href="${ctx}/gen/genScheme/delete.do?id=${genScheme.id}" onclick="return confirmx('确认要删除该生成方案吗？', this.href)">删除</a>

...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="oa:leave:edit"><li class="active"><a href="${ctx}/oa/leave/form.do">请假申请</a></li></shiro:hasPermission>
	</ul>
	<form:form id="inputForm" modelAttribute="leave" action="${ctx}/oa/leave/save.do" method="post" class="form-horizontal">
		<form:hidden path="id"/>

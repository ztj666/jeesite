...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/oa/leave.do">待办任务</a></li>
		<li class="active"><a href="${ctx}/oa/leave/list.do">所有任务</a></li>
		<shiro:hasPermission name="oa:leave:edit"><li><a href="${ctx}/oa/leave/form.do">请假申请</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="leave" action="${ctx}/oa/leave/list.do" method="post" class="breadcrumb form-search">
		...
		<c:forEach items="${page.list}" var="leave">
			...
			<tr>
				...
				<c:if test="${not empty task}">
					<td>${task.name}</td>
					<td><a target="_blank" href="${ctx}/act/task/trace/photo/${task.processDefinitionId}/${task.executionId}.do">跟踪</a></td>
				</c:if>

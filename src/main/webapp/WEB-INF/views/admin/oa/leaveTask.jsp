		...
		$(document).ready(function() {
			$(".handle").click(function(){
				...
				if(tkey=="deptLeaderAudit") {
					$.getJSON("${ctx}/oa/leave/detail/" + leaveId+".do" , function(data){
				...
				//调整申请
				if(tkey=="modifyApply") {
					$.getJSON("${ctx}/oa/leave/detail-with-vars/" + leaveId + "/" + taskId+".do", function(data){
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/oa/leave.do">待办任务</a></li>
		<li><a href="${ctx}/oa/leave/list.do">所有任务</a></li>
		<shiro:hasPermission name="oa:leave:edit"><li><a href="${ctx}/oa/leave/form.do">请假申请</a></li></shiro:hasPermission>
	</ul>
		...
		<tbody>
			<c:forEach items="${leaves}" var="leave">
				...
				<tr id="${leave.id }" tid="${task.id}">
					...
					<td>
						<a target="_blank" href="${ctx}/act/task/trace/photo/${task.processDefinitionId}/${task.executionId}.do">跟踪</a>

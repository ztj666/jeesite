...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/test/testData.do">单表列表</a></li>
		<li class="active"><a href="${ctx}/test/testData/form.do?id=${testData.id}">单表<shiro:hasPermission name="test:testData:edit">${not empty testData.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="test:testData:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="testData" action="${ctx}/test/testData/save.do" method="post" class="form-horizontal">
		<form:hidden path="id"/>

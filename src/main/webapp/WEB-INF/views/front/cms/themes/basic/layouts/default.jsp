...
<html>
<head>
	<title><sitemesh:title default="欢迎光临"/> - ${site.title} - Powered By FDP2</title>
	<%@include file="/WEB-INF/views/front/cms/include/head.jsp" %>
...
<body>
        ...
        <div class="container">
          ...
          <div class="nav-collapse">
            <ul id="main_nav" class="nav nav-pills">
		    	...
		    	<li id="scoreStore" >
			       	<a href="${ctx}/scoreStore/scoreStoreShow.htm" title="积分商城" >
			       	<font class="">积分商城</font></a>
				</li>
	...
	<div class="container">
		...
		<footer>
			<div class="footer_nav"><a href="${ctx}/guestbook${fns:getUrlSuffix()}" target="_blank">公共留言</a> | <a href="${ctx}/search${fns:getUrlSuffix()}" target="_blank">全站搜索</a> | <a href="${ctx}/map-${site.id}${fns:getUrlSuffix()}" target="_blank">站点地图</a> | <a href="mailto:elf8848@163.com">技术支持</a> | <a href="${pageContext.request.contextPath}${fns:getAdminPath()}/index.do" target="_blank">后台管理</a></div>

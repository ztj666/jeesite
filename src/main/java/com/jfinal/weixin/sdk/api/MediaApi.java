...
import com.jfinal.weixin.sdk.api.entity.DownloadMediaResponse;
import com.jfinal.weixin.sdk.utils.HttpUtils;
import com.jfinal.weixin.sdk.utils.JSONUtil;
import com.jfinal.weixin.sdk.utils.JsonUtils;
import com.jfinal.weixin.sdk.utils.NetWorkCenter;
import com.jfinal.weixin.sdk.utils.StreamUtil;

/**
 * 素材管理
 * 
 * @author l.cm
 *         文档：http://mp.weixin.qq.com/wiki/5/963fc70b80dc75483a271298a76a8d59.
 *         html
 */
public class MediaApi {
	 ...
	 * 具体是，图片大小不超过2M，支持bmp/png/jpeg/jpg/gif格式，语音大小不超过5M，长度不超过60秒，支持mp3/wma/wav/
	 * amr格式
	 * 
	 * @param file
	 *            文件
	 ...
	 * @return 响应对象
	 */
	public static DownloadMediaResponse downloadMedia(String mediaId) {
		DownloadMediaResponse response = new DownloadMediaResponse();
		String url = "http://file.api.weixin.qq.com/cgi-bin/media/get?access_token="
				+ AccessTokenApi.getAccessTokenStr() + "&media_id=" + mediaId;

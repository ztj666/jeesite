...
import com.qhwl.admin.sys.service.OfficeService;
...
//        model.addAttribute("list", officeService.findAll());
	...
	public String save(Office office, Model model, RedirectAttributes redirectAttributes) {
		if(Global.isDemoMode()){
			...
			return "redirect:" + adminPath + "/sys/office.do";
		}
		...
		return "redirect:" + adminPath + "/sys/office/list.do?id="+id+"&parentIds="+office.getParentIds();
	}
...
//		}
		return "redirect:" + adminPath + "/sys/office/list.do?id="+office.getParentId()+"&parentIds="+office.getParentIds();
	}

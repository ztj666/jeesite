...
import com.qhwl.admin.sys.security.FormAuthenticationFilter;
...
import com.qhwl.common.security.shiro.session.SessionDAO;
import com.qhwl.common.servlet.ValidateCodeServlet;
import com.qhwl.common.utils.CacheUtils;
import com.qhwl.common.utils.CookieUtils;
import com.qhwl.common.utils.IdGen;
...
//		}
	...
	public String loginFail(HttpServletRequest request, HttpServletResponse response, Model model) {
		Principal principal = UserUtils.getPrincipal();
		//String a=(String) request.getSession().getAttribute(ValidateCodeServlet.VALIDATE_CODE);
		// 如果已经登录，则跳转到管理首页
		if(principal != null){
			return "redirect:" + adminPath+"/index.do";
		}
...
//		try {
//			byte[] bytes = com.sc.common.utils.FileUtils.readFileToByteArray(
//					com.sc.common.utils.FileUtils.getFile("c:\\sxt.dmp"));

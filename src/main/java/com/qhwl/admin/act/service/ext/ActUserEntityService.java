 ...
 */
package com.qhwl.admin.act.service.ext;
...
import com.qhwl.admin.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.qhwl.admin.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.qhwl.admin.sys.entity.User(null, userId)))){
